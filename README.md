...
| `/api/v1/recipe-types/{recipeTypeId}` | Obtener tipo de receta por ID            | `GET`       | `/api/v1/recipe-types/{recipeTypeId}`       | `recipeTypeId` (path param, long)                                                                                                                                       | `{ "id": 0, "name": "string" }`                                                                                                                                                                                                                                                                                                                                                                           | (URL Swagger/doc)   |
