...
| `/meal-plan/{id}`        | Actualizar un meal plan por ID   | `PUT`       | `/api/v1/meal-plan/{mealPlanId}` | Todos los campos del objeto meal plan                                                                                                              | Igual que el response de GET                                                                                                                                                                                                                                                                                                                                               | (URL Swagger/doc)  |
| `/meal-plan/{id}`        | Eliminar un meal plan por ID     | `DELETE`    | `/api/v1/meal-plan/{mealPlanId}` | `mealPlanId` (path param)                                                                                                                          | `204 No Content` o mensaje de confirmación                                                                                                                                                                                                                                                                                                                                 | (URL Swagger/doc)  |
| `/endpoint-5`       | (Por definir)                  | `GET`        | `/endpoint-5`               |                                                                                                   |                                                                                                                                      | (URL)                                                 |
| `/endpoint-5`       | (Por definir)                  | `POST`       | `/endpoint-5`               |                                                                                                   |                                                                                                                                      | (URL)                                                 |
| `/endpoint-6`       | (Por definir)                  | `GET`        | `/endpoint-6`               |                                                                                                   |                                                                                                                                      | (URL)                                                 |
| `/endpoint-6`       | (Por definir)                  | `POST`       | `/endpoint-6`               |                                                                                                   |                                                                                                                                      | (URL)                                                 |
