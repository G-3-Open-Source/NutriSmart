...
| `/recetas`      |             Obtener recetas                                      | `GET`        | `/preferences/recipes`               |             Ninguno                                                                                |                                         `{"id":1,"name":"Tallarin Rojo","ingredients":"Fideos, Pomarola","description":"Plato tradicional de pasta con salsa de tomate.","category":"Almuerzo","preparationTime":30,"difficulty":"Fácil"},{"id":2,"name":"Ensalada","ingredients":"Vegetales, Limon","description":"Ensalada fresca con aderezo de limón.","category":"Cena","preparationTime":10,"difficulty":"Muy fácil"}`                                                                                         |                   https://recetas-crud.web.app/            |
| `/recetas`      |            Crear recetas                                       | `POST`       | `/preferences/recipes`               |       `id(int), name(string), ingredients(string), description(string), category(string), preparationTime(int), difficulty(string)`                                                                                      |                   `{"id":1,"name":"Tallarin Rojo","ingredients":"Fideos, Pomarola","description":"Plato tradicional de pasta con salsa de tomate.","category":"Almuerzo","preparationTime":30,"difficulty":"Fácil"},{"id":2,"name":"Ensalada","ingredients":"Vegetales, Limon","description":"Ensalada fresca con aderezo de limón.","category":"Cena","preparationTime":10,"difficulty":"Muy fácil"}`                                                                                                                |                 https://recetas-crud.web.app/                |
...
| `/meal-plan`             | Crear un nuevo meal plan         | `POST`      | `/api/v1/meal-plan`           | `name` (string), `description` (string), `calories` (float), `carbs` (float), `proteins` (float), `fats` (float), `profileId` (int), `category` (string), `isCurrent` (boolean), `entries` (array de objetos con `recipeId`, `mealPlanType`), `tags` (array de strings) | Igual que el response de GET                                                                                                                                                                                                                                                                                                                                               | (URL Swagger/doc)  |
| `/meal-plan/{id}`        | Obtener un meal plan por ID      | `GET`       | `/api/v1/meal-plan/{mealPlanId}` | `mealPlanId` (path param)                                                                                                                          | Igual que el response de GET                                                                                                                                                                                                                                                                                                                                               | (URL Swagger/doc)  |
...
| `/meal-plan/{id}`        | Eliminar un meal plan por ID     | `DELETE`    | `/api/v1/meal-plan/{mealPlanId}` | `mealPlanId` (path param)                                                                                                                          | `204 No Content` o mensaje de confirmación                                                                                                                                                                                                                                                                                                                                 | (URL Swagger/doc)  |
...
| **Sprint 3 Velocity**          |   Se estimarón un total de 33.5 hr                                                                                                                                                                                                                                                |
| **Sum of Story Points**        |      Nuestro equipo alcanzó    76                                                                                                                                                                                                                                            |
...
| Repository  | Branch             | Commit ID                              | Commit Message                                                         | Commit Message Body      | Committed on (Date) |
|-------------|--------------------|----------------------------------------|------------------------------------------------------------------------|--------------------------|---------------------|
| NutriSmart  | develop            | 79cc384f3b3e7115fafc610e35c4d86790ff1ae2 | feat: adding student outcome                                           | No description provided. | 2025-06-23          |
| NutriSmart  | develop            | 6f6994bd99e60eb8c6b54ed7a3aaec6ddb138350 | feat: adding sprint backlog                                            | No description provided. | 2025-06-23          |
| NutriSmart  | develop            | a572dfa0f8fb83da371be5db16dcf431e9e0750b | evidence for spring added                                              | No description provided. | 2025-06-23          |
| NutriSmart  | feature/prieto     | 23ae2c8e1cbbaca8613fb49656b62c04ee67fbf4 | feat: adding anexos & fixing sprint 2                                  | No description provided. | 2025-06-23          |
| NutriSmart  | develop            | 7a50c67eb5ed7e3e9a601efd420b685bf12da61b | Merge pull request #20 from G-3-Open-Source/feature/paredes             | No description provided. | 2025-06-23          |
| NutriSmart  | feature/paredes    | 79158f6c8b326a064fdfb91cb0609b9a050979a8 | Merge branch 'develop' into feature/paredes                            | No description provided. | 2025-06-23          |
| NutriSmart  | feature/paredes    | e55c2fa0205044c03db1b277e0efbd332c6990bf | feat: added student outcome                                             | No description provided. | 2025-06-23          |
| NutriSmart  | feature/paredes    | 94ca5d445f7442cdaa8316e3033a0a4fe36ff127 | Merge pull request #19 from G-3-Open-Source/feature/paredes             | No description provided. | 2025-06-23          |
| NutriSmart  | feature/paredes    | 08e9d4957fe3281fe3ea1ec1ab10e69a9cad384a | feat: add 5.3.1                                                         | No description provided. | 2025-06-23          |
| NutriSmart  | feature/rodriguez  | ab9948a7a12da98419d856b386bad4b9b0e317d2 | updating develop                                                        | No description provided. | 2025-06-23          |
| NutriSmart  | feature/paredes    | 8e6c38da73263b996beb5634026577c4dcfac5f5 | Merge pull request #18 from G-3-Open-Source/feature/paredes             | No description provided. | 2025-06-23          |
| NutriSmart  | feature/paredes    | 5015b7ea6aadf87c182acb3e25dc74691fb6d104 | feat: add interview                                                     | No description provided. | 2025-06-23          |
| NutriSmart  | develop            | dce4e0743c3c7e4053c70cee6449d10308ada8b6 | feat: adding interview design                                           | No description provided. | 2025-06-17          |
| NutriSmart  | develop            | 9d32239df6726bc08c836affc229a31fa59daf00 | Merge pull request #17 from G-3-Open-Source/feature/paredes             | No description provided. | 2025-06-16          |
| NutriSmart  | develop            | a0c48fda2582511a0d7aeb4fb61da54945598c88 | feat: fixed Aspect Leaders and collaborators                             | No description provided. | 2025-06-16          |
| NutriSmart  | develop            | c8ee911c93ef381836372de5788e2b2285b1eacb | feat: added sprint planning 3 and aspect leaders and collaborators       | No description provided. | 2025-06-16          |
| NutriSmart  | develop            | 67f97c27ba707d12c0dba5fde702e0c0d120119d | Merge pull request #16 from G-3-Open-Source/feature/paredes             | No description provided. | 2025-06-01          |
| NutriSmart  | feature/paredes    | 4c1f1025a0633cd16c77ff817fecba076c6014f4 | feat: completed my part of section 5.2.2.6                              | No description provided. | 2025-06-01          |
...
| `/meal-plan/{id}`        | Actualizar un meal plan por ID   | `PUT`       | `/api/v1/meal-plan/{mealPlanId}` | Todos los campos del objeto meal plan                                                                                                              | Igual que el response de GET                                                                                                                                                                                                                                                                                                                                               | (URL Swagger/doc)  |
| `/meal-plan/{id}`        | Eliminar un meal plan por ID     | `DELETE`    | `/api/v1/meal-plan/{mealPlanId}` | `mealPlanId` (path param)                                                                                                                          | `204 No Content` o mensaje de confirmación                                                                                                                                                                                                                                                                                                                                 | (URL Swagger/doc)  |
| `/endpoint-5`       | (Por definir)                  | `GET`        | `/endpoint-5`               |                                                                                                   |             | `/api/v1/user-profiles`             | Obtener todos los perfiles de usuario | `GET`       | `/api/v1/user-profiles`                   | Ninguno                                                                                                                                                                 | `{ "gender": "string", "height": 0.1, "weight": 0.1, "userScore": 0, "activityLevelId": 0, "objectiveId": 0, "allergyIds": [0] }`                                                                                                                                                                                                                                                                                                                                          | (URL Swagger/doc)   |
| `/api/v1/user-profiles`             | Crear un nuevo perfil de usuario      | `POST`      | `/api/v1/user-profiles`                   | `gender` (string), `height` (float), `weight` (float), `userScore` (int), `activityLevelId` (int), `objectiveId` (int), `allergyIds` (array de ints)                    | `{ "gender": "string", "height": 0.1, "weight": 0.1, "userScore": 0, "activityLevelId": 0, "objectiveId": 0, "allergyIds": [0] }`                                                                                                                                                                                                                                                                                                                                                | (URL Swagger/doc)   |
| `/api/v1/user-profiles/{id}`        | Obtener un perfil de usuario por ID   | `GET`       | `/api/v1/user-profiles/{id}`              | `id` (path param, int)                                                                                                                                                  | `{ "gender": "string", "height": 0.1, "weight": 0.1, "userScore": 0, "activityLevelId": 0, "objectiveId": 0, "allergyIds": [0] }`                                                                                                                                                                                                                                                                                                                                                | (URL Swagger/doc)   |
| `/api/v1/user-profiles/{id}`        | Actualizar un perfil de usuario por ID| `PUT`       | `/api/v1/user-profiles/{id}`              | `id` (path param, int), `gender` (string), `height` (float), `weight` (float), `userScore` (int), `activityLevelId` (int), `objectiveId` (int), `allergyIds` (array) | `{ "gender": "string", "height": 0.1, "weight": 0.1, "userScore": 0, "activityLevelId": 0, "objectiveId": 0, "allergyIds": [0] }`                                                                                                                                                                                                                                                                                                                                                | (URL Swagger/doc)   |
| `/api/v1/user-profiles/{id}`        | Eliminar un perfil de usuario por ID  | `DELETE`    | `/api/v1/user-profiles/{id}`              | `id` (path param, int)                                                                                                                                                  | `204 No Content`                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | (URL Swagger/doc)   |
| `/api/v1/users`                     | Obtener todos los usuarios            | `GET`       | `/api/v1/users`                           | Ninguno                                                                                                                                                                 | `{ "name": "string", "email": "string", "password": "string", "isActive": true, "birthDate": "string", "userProfileId": 0 }`                                                                                                                                                                                                                                                                                                                                                          | (URL Swagger/doc)   |
| `/api/v1/users`                     | Crear un nuevo usuario                | `POST`      | `/api/v1/users`                           | `name` (string), `email` (string), `password` (string), `isActive` (boolean), `birthDate` (string), `userProfileId` (int)                                              | `{ "name": "string", "email": "string", "password": "string", "isActive": true, "birthDate": "string", "userProfileId": 0 }`                                                                                                                                                                                                                                                                                                                                                          | (URL Swagger/doc)   |
| `/api/v1/users/{id}`                | Obtener un usuario por ID             | `GET`       | `/api/v1/users/{id}`                      | `id` (path param, int)                                                                                                                                                  | `{ "name": "string", "email": "string", "password": "string", "isActive": true, "birthDate": "string", "userProfileId": 0 }`                                                                                                                                                                                                                                                                                                                                                            | (URL Swagger/doc)   |
...
| `/api/v1/objectives`                | Crear un nuevo objetivo               | `POST`      | `/api/v1/objectives`                      | `id` (int), `objectiveName` (string), `score` (int), `description` (string)                                                                                            | `{ "id": 0, "objectiveName": "string", "score": 0, "description": "string" }`                                                                                                                                                                                                                                                                                                                                                                                                                | (URL Swagger/doc)   |
...
| `/api/v1/allergies`                 | Crear una nueva alergia               | `POST`      | `/api/v1/allergies`                       | `id` (int), `name` (string), `relatedIngredients` (array de objetos `{ name }`)                                                                                       | `{ "id": 0, "name": "string", "relatedIngredients": [{ "name": "string" }] }`                                                                                                                                                                                                                                                                                                                                                                                                                | (URL Swagger/doc)   |
| `/api/v1/activity-levels`           | Obtener todos los niveles de actividad| `GET`       | `/api/v1/activity-levels`                 | Ninguno                                                                                                                                                                 | `{ "createdAt": "2025-06-23T22:41:41.417Z", "updatedAt": "2025-06-23T22:41:41.417Z", "id": 0, "name": "string", "description": "string", "activityFactor": 0.1 }`                                                                                                                                                                                                                                                                                                                        | (URL Swagger/doc)   |
| `/api/v1/activity-levels`           | Crear un nuevo nivel de actividad     | `POST`      | `/api/v1/activity-levels`                 | `createdAt` (date-time), `updatedAt` (date-time), `id` (int), `name` (string), `description` (string), `activityFactor` (float)                                        | `{ "createdAt": "2025-06-23T22:41:41.416Z", "updatedAt": "2025-06-23T22:41:41.416Z", "id": 0, "name": "string", "description": "string", "activityFactor": 0.1 }`                                                                                                                                                                                                                                                                                                                        | (URL Swagger/doc)   | | `/api/v1/favorite-recipes`          | Crear una receta favorita              | `POST`      | `/api/v1/favorite-recipes`                  | `userId` (long), `recipeId` (long)                                                                                                                                       | `{ "userId": 0, "recipeId": 0 }`                                                                                                                                                                                                                                                                                                                                                                           | (URL Swagger/doc)   |
| `/api/v1/favorite-recipes/{userId}` | Obtener recetas favoritas por usuario  | `GET`       | `/api/v1/favorite-recipes/{userId}`         | `userId` (path param, long)                                                                                                                                             | `[ { "id": 0, "userId": 0, "recipeId": 0, "recipeName": "string" } ]`                                                                                                                                                                                                                                                                                                                                      | (URL Swagger/doc)   |
| `/api/v1/favorite-recipes/{userId}/{recipeId}` | Eliminar una receta favorita        | `DELETE`    | `/api/v1/favorite-recipes/{userId}/{recipeId}` | `userId` (path param, long), `recipeId` (path param, long)                                                                                                               | `204 No Content`                                                                                                                                                                                                                                                                                                                                                                                          | (URL Swagger/doc)   |
| `/api/v1/recipes`                   | Crear una nueva receta                 | `POST`      | `/api/v1/recipes`                           | `name` (string), `description` (string), `preparationTime` (int), `difficulty` (string), `categoryId` (long), `recipeTypeId` (long), `userId` (long)                     | `{ "name": "string", "description": "string", "preparationTime": 0, "difficulty": "string", "categoryId": 0, "recipeTypeId": 0, "userId": 0 }`                                                                                                                                                                                                                                                             | (URL Swagger/doc)   |
| `/api/v1/recipes/{recipeId}`        | Obtener receta por ID                  | `GET`       | `/api/v1/recipes/{recipeId}`                | `recipeId` (path param, long)                                                                                                                                           | `{ "id": 0, "userId": 0, "name": "string", "description": "string", "preparationTime": 0, "difficulty": "string", "category": "string", "recipeType": "string" }`                                                                                                                                                                                                                                          | (URL Swagger/doc)   |
| `/api/v1/recipes/{recipeId}/ingredients/{ingredientId}` | Añadir ingrediente a una receta  | `POST`      | `/api/v1/recipes/{recipeId}/ingredients/{ingredientId}` | `recipeId` (path param, long), `ingredientId` (path param, long)                                                                                                         | `204 No Content`                                                                                                                                                                                                                                                                                                                                                                                          | (URL Swagger/doc)   |
| `/api/v1/ingredients`               | Crear un nuevo ingrediente             | `POST`      | `/api/v1/ingredients`                       | `name` (string), `calories` (double), `carbohydrates` (double), `proteins` (double), `fats` (double), `macronutrientValuesId` (long)                                     | `{ "name": "string", "calories": 0.0, "carbohydrates": 0.0, "proteins": 0.0, "fats": 0.0, "macronutrientValuesId": 0 }`                                                                                                                                                                                                                                                                                    | (URL Swagger/doc)   |
| `/api/v1/ingredients/{ingredientId}` | Eliminar un ingrediente                 | `DELETE`    | `/api/v1/ingredients/{ingredientId}`        | `ingredientId` (path param, long)                                                                                                                                       | `204 No Content`                                                                                                                                                                                                                                                                                                                                                                                          | (URL Swagger/doc)   |
| `/api/v1/categories`                | Crear una nueva categoría              | `POST`      | `/api/v1/categories`                        | `name` (string)                                                                                                                                                         | `{ "name": "string" }`                                                                                                                                                                                                                                                                                                                                                                                    | (URL Swagger/doc)   |
| `/api/v1/categories/{categoryId}`   | Obtener categoría por ID               | `GET`       | `/api/v1/categories/{categoryId}`           | `categoryId` (path param, long)                                                                                                                                         | `{ "id": 0, "name": "string" }`                                                                                                                                                                                                                                                                                                                                                                           | (URL Swagger/doc)   |
| `/api/v1/recipe-types`              | Crear un nuevo tipo de receta           | `POST`      | `/api/v1/recipe-types`                      | `name` (string)                                                                                                                                                         | `{ "name": "string" }`                                                                                                                                                                                                                                                                                                                                                                                    | (URL Swagger/doc)   |
| `/api/v1/recipe-types/{recipeTypeId}` | Obtener tipo de receta por ID            | `GET`       | `/api/v1/recipe-types/{recipeTypeId}`       | `recipeTypeId` (path param, long)                                                                                                                                       | `{ "id": 0, "name": "string" }`                                                                                                                                                                                                                                                                                                                                                                           | (URL Swagger/doc)   | | `/api/v1/tracking`                                                       | Crear un nuevo tracking                                      | `POST`      | `/api/v1/tracking`                                                    | Body con datos de tracking                                                                                                                     | `{ "id": 0, "userId": 0, "startDate": "2025-06-23", "endDate": "2025-06-30" }` *(ejemplo ficticio)*                                                                                                                                                                                                                                                               | (URL Swagger/doc)     |
| `/api/v1/tracking/user/{userId}`                                        | Obtener tracking por ID de usuario                           | `GET`       | `/api/v1/tracking/user/{userId}`                                     | `userId` (path param, int)                                                                                                                      | `{ "id": 0, "userId": 1, "startDate": "2025-06-23", "endDate": "2025-06-30" }`                                                                                                                                                                                                                                                                                    | (URL Swagger/doc)     |
| `/api/v1/tracking/macronutrients/consumed/tracking/{trackingId}`        | Obtener macros consumidos por tracking                       | `GET`       | `/api/v1/tracking/macronutrients/consumed/tracking/{trackingId}`     | `trackingId` (path param, int)                                                                                                                  | `{ "calories": 1200.0, "carbs": 150.0, "proteins": 80.0, "fats": 50.0 }`                                                                                                                                                                                                                                                                                          | (URL Swagger/doc)     |
| `/api/v1/macronutrients/consumed/tracking/{trackingId}`                 | Obtener valores de macronutrientes consumidos                | `GET`       | `/api/v1/macronutrients/consumed/tracking/{trackingId}`              | `trackingId` (path param, int)                                                                                                                  | `{ "calories": 1200.0, "carbs": 150.0, "proteins": 80.0, "fats": 50.0 }`                                                                                                                                                                                                                                                                                          | (URL Swagger/doc)     |
...
| `/api/v1/tracking-goals/{trackingGoalId}/target-macros`                | Obtener macros objetivos por ID de Tracking Goal             | `GET`       | `/api/v1/tracking-goals/{trackingGoalId}/target-macros`              | `trackingGoalId` (path param, int)                                                                                                              | `{ "targetCalories": 2000.0, "targetCarbs": 250.0, "targetProteins": 100.0, "targetFats": 70.0 }`                                                                                                                                                                                                                                                                | (URL Swagger/doc)     |
| `/api/v1/tracking-goals/user/{userId}`                                  | Obtener Tracking Goal por usuario                            | `GET`       | `/api/v1/tracking-goals/user/{userId}`                               | `userId` (path param, int)                                                                                                                      | `{ "id": 1, "userId": 1, "targetCalories": 2000.0, "targetCarbs": 250.0, "targetProteins": 100.0, "targetFats": 70.0 }`                                                                                                                                                                                                                                           | (URL Swagger/doc)     |
| `/api/v1/meal-plan-entries/{mealPlanEntryId}`                           | Actualizar una entrada de meal plan                          | `PUT`       | `/api/v1/meal-plan-entries/{mealPlanEntryId}`                        | `mealPlanEntryId` (path param, int), body con los datos a actualizar                                                                           | `{ "id": 1, "recipeId": 10, "mealPlanType": "LUNCH", "mealPlanId": 3 }`                                                                                                                                                                                                                                                                                          | (URL Swagger/doc)     |
| `/api/v1/meal-plan-entries/tracking/{trackingId}`                       | Añadir una nueva entrada de meal plan al tracking            | `POST`      | `/api/v1/meal-plan-entries/tracking/{trackingId}`                    | `trackingId` (path param, int), body con `recipeId`, `mealPlanType`                                                                            | `{ "id": 1, "recipeId": 10, "mealPlanType": "LUNCH", "mealPlanId": 3 }`                                                                                                                                                                                                                                                                                          | (URL Swagger/doc)     |
| `/api/v1/meal-plan-entries/tracking/{trackingId}`                       | Obtener todas las entradas de meal plan por tracking         | `GET`       | `/api/v1/meal-plan-entries/tracking/{trackingId}`                    | `trackingId` (path param, int)                                                                                                                  | `[ { "id": 1, "recipeId": 10, "mealPlanType": "BREAKFAST", "mealPlanId": 3 }, ... ]`                                                                                                                                                                                                                                                                            | (URL Swagger/doc)     |
| `/api/v1/meal-plan-entries/tracking/{trackingId}/entry/{mealPlanEntryId}` | Eliminar una entrada específica del meal plan                | `DELETE`    | `/api/v1/meal-plan-entries/tracking/{trackingId}/entry/{mealPlanEntryId}` | `trackingId` y `mealPlanEntryId` (path param, int)                                                                                           | `204 No Content`                                                                                 | (URL Swagger/doc)     |
| `/api/v1/recommendation-templates`           | Obtener todos los templates de recomendación     | `GET`       | `/api/v1/recommendation-templates`                | Ninguno                                                                                                                              | `[ { "id": 1, "title": "Plan nutricional para masa muscular", "content": "Incluye proteína magra, carbos complejos y grasas buenas", "recommendations": [] } ]` | (URL Swagger/doc)   |
| `/api/v1/recommendation-templates`           | Crear un nuevo template                          | `POST`      | `/api/v1/recommendation-templates`                | `title` (string), `content` (string)                                                                                                | `{ "id": 2, "title": "Plan post-entreno", "content": "Incluye batidos con whey protein, avena y banana", "recommendations": [] }`                                                                                                                                                                                                                                                                    | (URL Swagger/doc)   |
| `/api/v1/recommendations/user/{userId}`      | Obtener recomendaciones por ID de usuario        | `GET`       | `/api/v1/recommendations/user/1`                  | `userId` (path param)                                                                                                                | `[ { "id": 5, "userId": { "value": 1 }, "templateId": 2, "reason": "Fase de volumen", "notes": "Comidas densas en calorías", "timeOfDay": "MORNING", "score": 9.1, "status": "ACTIVE", "assignedAt": "2025-06-23T04:49:59.728Z" } ]`                                                                                                                                                                  | (URL Swagger/doc)   |
...
<p align="center">
  <img src="./imagenes/entrevistas/entrevistavalidacion2.png" alt="Entrevista 1" width="400">
</p>

Carlos es un nutricionista de 30 años con experiencia previa usando plataformas como Nutrium y Dietowin, además de herramientas como Excel. Tiene un nivel intermedio en el uso de aplicaciones de gestión y valora la funcionalidad por encima de lo estético. Durante la prueba del frontend de NutriSmart, lo encontró limpio, intuitivo y comprensible. Destacó la necesidad de accesos rápidos para funciones clave como el ajuste de planes, y remarcó que, si bien es útil para profesionales, debería simplificarse aún más si se orienta a pacientes. Sugiere mejoras como alertas, integración con apps de salud y un diseño más relajante y responsivo en móviles. Aprecia elementos visuales interactivos siempre que sean sutiles y funcionales.

| Detalle           | Información                                  |
|-------------------|----------------------------------------------|
| **Entrevistador** | Sebastián Rodríguez Macedo                   |
